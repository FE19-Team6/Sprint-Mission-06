...
> **FE19-Team6**의 스프린트 06 프로젝트입니다.<br/>
 각자 **개인 브랜치**에서 기능을 구현하고, 브랜치별로 작업을 관리합니다.<br/>
 main에는 직접 머지하지 않습니다.<br/>
 **모든 커밋과 PR에 이슈 번호 필수로 연동**합니다.<br/>
...
> 이번 스프린트는 **마일스톤/이슈 기반**으로 운영합니다.<br/>
> 데드라인 설정과 **작업 시간 산정도 테스트**합니다.<br/>
> 브랜치별로 기능을 완성하고 **피드백 중심으로 리뷰**하는 형태입니다.<br/>
